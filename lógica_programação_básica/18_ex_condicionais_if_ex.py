...
if primeiro_valor > segundo_valor:
    print(f"O 1º valor={primeiro_valor} é maior que o 2º valor={segundo_valor}")
elif primeiro_valor == segundo_valor:
    print(f"O 1º valor={primeiro_valor} é igual ao 2º valor={segundo_valor}")
else:
    print(f"O 2º valor={segundo_valor} é maior que o 1º valor={primeiro_valor}")
